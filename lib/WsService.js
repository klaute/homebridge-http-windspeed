...
class Weather extends WsService {
  ...
  checkObservation(observation) {
    const o = observation
    this.vdebug('WsService:217: observation: %j', o)
    if (o == null) {
      return
    }
    this.log("WsService:221: temperature="+o.temperature)
...
class DailyForecast extends WsService {
  ...
  checkObservation(observation) {
    ...
    this.vdebug('WsService:369: observation: %j', o)
    if (o == null) {
      return
    }
...
class HourlyForecast extends WsService {
  ...
  checkObservation(observation) {
    const o = observation
    this.vdebug('WsService:497: observation: %j', o)
    if (o == null) {
      return
    }
